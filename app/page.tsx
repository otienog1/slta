      ...
      <div className="grid grid-cols-1 md:grid-cols-2">
        <div className="bg-gray-100 p-12 md:p-24 flex justify-start items-center">
          <div className="max-w-md">
            ...
            <div className="text-md text-gray-600 md:text-base mb-6 leading-relaxed" dangerouslySetInnerHTML={{ __html: page.acf.section_5.mission_and_values.content }}></div>
          </div>
        </div>
        <div className="bg-white p-12 md:p-24 flex justify-end items-center">123</div>
      </div>
